...
class MusicianControllerUnitTests {
    ...
    void onCall_getMusician_returnAllMusicians() throws Exception {
        ...
        mockMvc.perform(get("/musician"))
                ...
                .andExpect(jsonPath("$[1].yearOfBirth",is(1915)))
                .andExpect(jsonPath("$[1].yearOfDeath",is(2012)))
                ...
                .andExpect(jsonPath("$[2].yearOfBirth",is(1915)))
                .andExpect(jsonPath("$[2].yearOfDeath",is(2012)))
